...
describe('Test component: UserDetailsPage', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    mockRoute.params.id = 'test-user-id';
  ...
  describe('test function: loadData', () => {
    ...
    it('should redirect to users list when getEntityById throws', async () => {
  ...
  describe('test function: goToEdit', () => {
    it('should navigate to edit page', () => {
      ...
      expect(mockRouter.push).toHaveBeenCalledWith('/users/test-user-id/edit');
    });
  });
