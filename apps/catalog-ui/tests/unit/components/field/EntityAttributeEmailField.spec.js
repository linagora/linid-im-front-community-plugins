...
import EntityAttributeEmailField from '../../../../src/components/field/EntityAttributeEmailField.vue';
...
describe('Test component: EntityAttributeEmailField', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    wrapper = shallowMount(EntityAttributeEmailField, {
      props: {
  ...
  describe('Test function: updateValue', () => {
    it('should emit event', () => {
      wrapper.vm.localValue = 'test@example.com';
  ...
  describe('Test watch: entity', () => {
    it('should update localValue when entity attribute value changes', async () => {
      expect(wrapper.vm.localValue).toEqual('test@example.com');
      ...
      expect(wrapper.vm.localValue).toEqual('new@example.com');
    });
    ...
    it('should update localValue when entity reference changes', async () => {
      ...
      expect(wrapper.vm.localValue).toEqual('updated@example.com');
    });

    it('should not update localValue when another entity attribute changes', async () => {
      wrapper.vm.localValue = 'initial-email@example.com';
