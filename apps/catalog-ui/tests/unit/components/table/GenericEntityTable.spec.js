...
describe('Test component: GenericEntityTable', () => {
  ...
  describe('Test function: getPaginationLabel', () => {
    it('should return correct pagination label', () => {
      const result = wrapper.vm.getPaginationLabel(1, 10, 100);
