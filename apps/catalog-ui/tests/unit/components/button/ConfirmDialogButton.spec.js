...
describe('Test component: ConfirmDialogButton', () => {
  ...
  describe('Test props: method', () => {
    it('should default to DELETE', () => {
      expect(wrapper.vm.method).toBe('DELETE');
    });
  ...
  describe('Test computed: isDisabled', () => {
    ...
    it('should be disabled when disable is set', () => {
      wrapper = mountComponent({ disable: true });

      expect(wrapper.vm.isDisabled).toBe(true);
    });

    it('should be disabled when the disableWhen template renders to true', () => {
      wrapper = mountComponent({
    ...
    it('should be enabled when the disableWhen template renders to false', () => {
      wrapper = mountComponent({ disableWhen: '{{ not entity.deletable }}' });
