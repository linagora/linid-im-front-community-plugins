...
/**
 * Configuration options for a generic entity creation page.
 */
export interface ModuleGenericCreationPageOptions extends ModulePageOptions {
  /**
...
/**
 * UI props for the GenericCreationPage component, keyed by form section id.
 */
export interface GenericCreationPageUIProps {
  /**
