...
/**
 * Configuration options for a generic entity edition page.
 */
export interface ModuleGenericEditionPageOptions extends ModulePageOptions {
  /**
  ...
  /**
   * Configuration for edit forms with sections and field ordering.
...
/**
 * Configuration for a section in edit forms.
 */
