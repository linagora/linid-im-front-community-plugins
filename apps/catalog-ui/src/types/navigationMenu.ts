...
export interface NavigationMenuOutputs {
   ...
   */
  'update:activeItem': [item: NavigationMenuItem];
}

/**
 * UI props for the NavigationMenu component.
 */
export interface NavigationMenuUIProps {
  /**
   * Tabs props.
   */
  tabs: LinidQTabsProps;
  /**
   * Route tab props mapped by item ID.
   */
  routes: Record<string, LinidQRouteTabProps>;
}
