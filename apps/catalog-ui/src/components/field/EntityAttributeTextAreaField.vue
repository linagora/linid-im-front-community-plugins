...
<template>
  ...
  <q-input
    ...
    class="entity-attribute-textarea-field"
    type="textarea"
    v-bind="uiProps"
...
const props = withDefaults(
  defineProps<AttributeFieldProps<FieldTextAreaSettings>>(),
  {
    ignoreRules: false,
  }
);
...
/**
 * Emits an 'update:entity' event with the updated entity object when the text changes.
