...
* A bundler supporting **Module Federation** (Webpack 5)

---

## **📦 Installation**

Install `catalogUI` as a dependency in your module:

### **With npm**

```bash
npm install @linagora/catalog-ui
```

### **With pnpm**

```bash
pnpm add @linagora/catalog-ui
```
