...
| --------------------- | --------------------- | ------- | ---------------------------------------------------------------- |
| `entity`              | `Record<string, any>` | —       | Entity object containing the attributes to display               |
...
```vue
<EntityDetailsCard :entity="user" :fieldOrder="['username', 'email']" uiNamespace="users" instanceId="users" />
```
...
```vue
<EntityDetailsCard :entity="user" :fieldOrder="['username', 'email']" :showRemainingFields="true" uiNamespace="users" instanceId="users" />
```
...
```vue
<EntityDetailsCard :entity="{}" :fieldOrder="['username', 'email']" :isLoading="true" uiNamespace="users" instanceId="users" />
```
