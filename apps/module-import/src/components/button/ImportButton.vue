...
import type { ImportButtonProps } from '../../types/ImportButton';
...
const { t } = useScopedI18n(`${props.instanceId}.ImportButton`);
const { ui } = useUiDesign();
const uiProps = ui<LinidQBtnProps>(`${props.instanceId}.import-button`, 'q-btn');
const moduleConfig = getModuleHostConfiguration<ModuleImportOptions>(
  props.instanceId
)!;

/**
 * Navigates to the module import entry route.
 */
function goToImport() {
