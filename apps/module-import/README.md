...
Documentation for the Users Module is located in the `apps/module-import/docs/` folder:
...
- An **Import button** appears in the module’s toolbar (configured in `design.json`).
- Admins upload a CSV with new users.
